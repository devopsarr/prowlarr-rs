...
pub struct DownloadClientResource {
    ...
    pub categories: Option<Option<Vec<models::DownloadClientCategory>>>,
    #[serde(rename = "supportsCategories", skip_serializing_if = "Option::is_none")]
